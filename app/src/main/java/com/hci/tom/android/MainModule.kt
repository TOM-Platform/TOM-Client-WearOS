...
import com.hci.tom.android.db.ExerciseDataDao
...
class MainModule {
    ...
    @Singleton
    @Provides
    fun provideExerciseDataDao(@ApplicationContext context: Context): ExerciseDataDao =
        ExerciseDataDatabase.getInstance(context).exerciseDataDao()
